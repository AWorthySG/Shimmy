...
export function Footer() {
  ...
  return (
    <footer className="bg-cream-dark text-charcoal-light safe-bottom">
      {/* Top accent line — vermillion gradient */}
      <div className="h-[2px] bg-gradient-to-r from-transparent via-vermillion to-transparent" />
        ...
        <div className="grid gap-10 sm:gap-12 md:grid-cols-3">
          ...
          <div>
            <div className="flex items-center gap-3">
              <h3 className="font-serif text-xl sm:text-2xl text-charcoal tracking-wide sparkle">
                Shimmy
              </h3>
              {/* Vermillion seal mark */}
              <span className="inline-flex items-center justify-center w-7 h-7 border border-vermillion/60 text-vermillion text-xs font-serif leading-none">
                美
              </span>
            </div>
            <p className="mt-1 text-[9px] sm:text-[10px] uppercase tracking-[0.3em] text-vermillion-dark">
              Beauty Studio
            </p>
